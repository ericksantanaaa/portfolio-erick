    ...
    <section id="skills" className="bg-dark-card py-24 w-full">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 items-start gap-12 md:gap-0">
          ...
          {/* COLUNA: Tools and Design - CORRIGIDA */}
          <div className="flex flex-col items-start md:pl-4">
            ...
            <ul className="space-y-6 text-white text-[17px] font-light mb-12">
              <li>. Git & GitHub</li>
              <li>. Monday</li> {/* Corrigido de Monda para Monday, comum em ferramentas de design/gestão */}
              <li>. Canva PRO</li>
            </ul>
