  ...
  const projects = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&q=80&w=800", // Substitua pelas suas imagens
    },
    {
        ...
        <div className="flex flex-col md:flex-row gap-16">
          ...
          <div className="md:w-1/3 flex flex-col items-start">
            ...
            <p className="text-gray-400 text-lg leading-relaxed mb-8 max-w-xs">
              These are my few selected projects where I designed the User
              interface to build a clickable prototype.
            </p>

            <p className="text-gray-400 text-lg leading-relaxed mb-12 max-w-xs">
              Like what you've seen so far? Then get in touch, and we discuss
              your ideas together.
            </p>
